...
def create_MEM(rows_guess, rows_menu, columns_guess, columns_menu,
    ...
    if rows_guess and rows_menu:
        ...
        string_out='Fig_fit and ERC defined'
        ...
        if isinstance(fig_ERC, list):
            ...
            if len(fig_ERC) > 0:
                ...
                string_out='Should work'
                
            elif len(fig_ERC) == 0:
                fig_ERC = go.Figure(data=go.Scatter(
                                x=[0,1,2,3,4,5],
                                y=[20,1,1,19,1,1]
                                ))
        ...
        #     return fig_fit, graph_Style_fit, fig_fit, graph_Style_ERC, string_out
        
        # except:
        #     fig_ERC=None
        #     graph_Style_ERC = dict(display='none')
        #     string_out='We tried to ERC but only got fig'
            
        gc.collect()
            
        # return fig_fit, graph_Style_fit, fig_ERC, graph_Style_ERC, string_out
